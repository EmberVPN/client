...
export default function Button({ children, className, size = "sm", color = "primary", ...props }: Partial<ButtonProps> & HTMLAttributes<HTMLButtonElement> & { type?: "button" | "submit" | "reset" }) {
	...
	const base = "m-1 rounded-md font-medium uppercase text-white shadow-md font-roboto tracking-[0.75px] hover:shadow-lg duration-150 select-none  appearance-none";
	const sizes = {
