...
export default function Titlebar({ children, resizeable = true, minimizeable = true, className, ...props }: Props & HTMLAttributes<HTMLDivElement>): JSX.Element {
	...
	return (
		<div className={ classNames("flex w-full items-center relative select-none text-gray-800 dark:text-gray-200 z-[70] font-system app-drag text-xs", className, isMac ? "h-7 justify-center font-medium" : "h-8 justify-between") }
			{ ...props }>
